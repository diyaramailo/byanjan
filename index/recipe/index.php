...
<body>
    <!-- navigation -->
    <nav>
        <img src="byanjan-removebg-preview.png" alt="logo">
            ...
            <ul>
                ...
                <li><div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      <a href="terai.html">Terai Region</a>
                      <a href="hilly.html">Hilly Region</a>
                      <a href="himalayan.html">Himalayan Region</a>
                    </div>
                  </div></li>
                <li><a href="login.html">My Profile<i class="fa-solid fa-right-to-bracket"></i></a></li>
            </ul>
    </nav>
    <!-- name and rating -->
    <section id="rec-name">
    ...
    <section id="calculator">
        <a href="calculator_design.html">Calculate Required Quantity here</a>
    </section>
